...
public class ServerFailed extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ServerFailed frame = new ServerFailed();
	...
	public ServerFailed() {
		...
		JLabel text = new JLabel("No se pudo iniciar el servido ");
		text.setHorizontalAlignment(SwingConstants.CENTER);
		text.setForeground(new Color(30, 144, 255));
		text.setFont(new Font("Cocogoose", Font.PLAIN, 19));
		text.setBounds(49, 0, 372, 64);
		panel.add(text);

		JButton btnAtras = new JButton("Ok");
		btnAtras.setBounds(174, 65, 101, 39);
		panel.add(btnAtras);
